...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1.5, user-scalable=no">
     <?=Html::csrfMetaTags() ?>
    <title>Вход в Личный Кабинет SaleMen ● Бесплатная доска объявлений</title>
...
.btn-warning {
	...
	<li class="dropdown" id="brands_products2">
     ...
     <li><a href="<?=Url::to (['/nedvigcategory/8', 'ads' =>$tkva])?>">Квартиры<div style="display: none;"> Краснодара Краснодарского края и юга России</div><div style="display: none;"> Краснодара Краснодарского края и юга России</div></a></li>
