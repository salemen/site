...
<head>
    ...
    <?= Html::csrfMetaTags() ?>
    <title><?= Html::encode($this->title) ?> ● 🏯 Объявления НЕДВИЖИМОСТЬ Краснодара,Краснодарского края и юга России</title>
	<?=$this->registerMetaTag(['name' => 'keywords', 'content' => 'Вся НЕДВИЖИМОСТЬ<div style="display: none;"> Краснодара Краснодарского края и юга России</div> Здесь, купить, продать дом, квартир, дачу, земельный участок, офис, помещение, склад, магазин и другую НЕДВИЖИМОСТЬ<div style="display: none;"> Краснодара Краснодарского края и юга России</div>. Сайт Бесплатных объявлений по покупке, продаже и аренде недвижимости. Все услуги сайта Бесплатные. Купи-Продай и отдыхай ']);
$this->registerMetaTag(['name' => 'description', 'content' => 'Объявление: '.$this->title .'. '.'Покупка, продажа или аренда квартиры, комнаты, дома или земельного участка в Краснодаре и Краснодарском крае']);?>
    <?php $this->head() ?>
