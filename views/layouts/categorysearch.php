...
<head>
    ...
    $this->registerMetaTag(['name' => 'description', 'content' => 'БЕСПЛАТНАЯ доска объявлений SaleMen, в Краснодаре и Краснодарском крае, Ростовской области и в Ставропольском крае. Купить, продать, арендовать НЕДВИЖИМОСТЬ<div style="display: none;"> Краснодара Краснодарского края и юга России</div>, автотехнику, личные вещи и оказании различных услуг.']);?>
    <?php $this->head() ?>
