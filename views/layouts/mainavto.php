...
<head>
    ...
    <?= Html::csrfMetaTags() ?>
    <title> 🚍 <?= Html::encode($this->title) ?> ● Бесплатная доска объявлений Краснодара, Краснодарского края и юга России_SaleMen</title>
	<?= $this->registerMetaTag(['name' => 'keywords', 'content' => 'Покупка, продажа автотехники и сопутствующих товаров. Грузова, легковая, спецтехника, мототехника и катера, яхты, лодки. Все услуги сайта Бесплатные ']);
        $this->registerMetaTag(['name' => 'description', 'content' => 'Покупка, продажа автотехники, автомобилей и сопутствующих товаров в Краснодарском крае, Ростовской области и Ставропольском крае. Грузова, легковая, спецтехника, мототехника и катера, яхты, лодки. Бесплатная доска объявлений SaleMen. ']);?>
    <?php $this->head() ?>
 ...
 <strong id="blink2" style ="padding-right: 2px"> Подать объявление</strong></a></li>-->
   ...
   \yii\bootstrap\Modal::end();
	...
	<a href ="<?= yii\helpers\Url::to (['cart/avtokomplekt']) ?>" class= "showSearchkomplekt">
										<i class="btn btn-warning">Комплектующие и Автозапчасти</i></a>  
