...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1.5, user-scalable=no">
     <?=Html::csrfMetaTags() ?>
    <title>✅ <?= Html::encode($this->title) ?> ● Бесплатная доска объявлений Кранодара, Краснодарского края и юга России</title>
    ...
    $this->registerMetaTag(['name' => 'description', 'content' => $this->title .'. '.'Объявления Краснодара, Краснодарского края, Ростовской области и Ставропольского края. НЕДВИЖИМОСТЬ<div style="display: none;"> Краснодара Краснодарского края и юга России</div>, Автотехника, Личные вещи, услуги, работа. Подать объявление бесплатно.']);?>
    <?php $this->head() ?>
