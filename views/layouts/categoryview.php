...
<head>
	...
	<?=$this->registerMetaTag(['name' => 'keywords', 'content' => 'SaleMen Купи продай и отдыхай. Универсальная, удобная и бесплатная платформа для покупок и продаж. Объявления Краснодара и Краснодарского края. ']);
    $this->registerMetaTag(['name' => 'description', 'content' => 'Объявление: '.$this->title .'. '.'Объявления Краснодара, Краснодарского края, Ростовской области и Ставропольского края']);?>
    <?php $this->head() ?>
