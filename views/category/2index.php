...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
	<head>
		...
		<!-- REVOLUTION SLIDER -->
		<link href="assets1/plugins/slider.revolution/css/extralayers.css" rel="stylesheet" type="text/css" />
		<link href="assets1/plugins/slider.revolution/css/settings.css" rel="stylesheet" type="text/css" />
	</head>
	...
	<!--
		...
		data-background="assets1/images/boxed_background/1.jpg"
	-->
	<body class="smoothscroll enable-animation">
		...
		<div id="wrapper">
				...
				<header id="topNav">
					<div class="container">
							...
							<li class="quick-cart">
								...
								<div class="quick-cart-box">
									...
									<div class="quick-cart-wrapper">
										...
										<a href="#"><!-- cart item -->
											<img src="assets1/images/demo/people/300x300/4-min.jpg" width="45" height="45" alt="" />
											<h6><span>2x</span> RED BAG WITH HUGE POCKETS</h6>
											<small>$37.21</small>
										</a><!-- /cart item -->

										<a href="#"><!-- cart item -->
											<img src="assets1/images/demo/people/300x300/5-min.jpg" width="45" height="45" alt="" />
						...
						<a class="logo pull-left" href="index.html">
							<img src="assets1/images/logo_light.png" alt="" /> <!-- light logo -->
							<img src="assets1/images/logo_dark.png" alt="" /> <!-- dark logo -->
						</a>
									...
									<li class="dropdown active"><!-- HOME -->
										...
										<ul class="dropdown-menu">
											<li class="dropdown active">
												...
												<ul class="dropdown-menu">
													<li class="active"><a href="index-corporate-1.html">CORPORATE LAYOUT 1</a></li>
			...
			<section id="slider" class="fullwidthbanner-container roundedcorners">
				...
				<div class="fullscreenbanner" data-navigationStyle="preview4">
					<ul class="hide">
						...
						<!-- SLIDE  -->
						<li data-transition="random" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off" data-title="Slide title 1" data-thumb="assets1/images/demo/150x99/27-min.jpg">

							<img src="assets1/images/1x1.png" data-lazyload="assets1/images/demo/1200x800/27-min.jpg" alt="" data-bgfit="cover" data-bgposition="center bottom" data-bgrepeat="no-repeat" />
						...
						<!-- SLIDE -->
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off" data-title="Slide title 2" data-thumb="assets1/images/demo/video/neuron_thumb.jpg">

							<img src="assets1/images/1x1.png" data-lazyload="assets1/images/demo/video/neuron.jpg" alt="video" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
							...
							<div class="tp-caption tp-fade fadeout fullscreenvideo"
								...
								<video class="fullvideo" preload="none" poster="assets1/images/demo/video/neuron.jpg">
									<source src="assets1/images/demo/video/neuron.webm" type="video/webm" />
									<source src="assets1/images/demo/video/neuron.mp4" type="video/mp4" />
								</video>
						...
						<!-- SLIDE  -->
						<li data-transition="random" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off" data-title="Slide title 3" data-thumb="assets1/images/demo/150x99/11-min.jpg">

							<img src="assets1/images/1x1.png" data-lazyload="assets1/images/demo/1200x800/11-min.jpg" alt="" data-bgfit="cover" data-bgposition="center bottom" data-bgrepeat="no-repeat" />
			...
			<!-- PARALLAX -->
			<section class="parallax parallax-2 nopadding-bottom" style="background-image: url('assets1/images/demo/wall3-min.jpg');">
				...
				<div class="container">
					...
					<div class="margin-top-80 text-center">
						<img class="img-responsive wow fadeInUp" data-wow-delay="0.4s" src="assets1/images/demo/browsers.png" alt="" />
					</div>
				</div>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6">
							<img class="img-responsive wow fadeIn" data-wow-delay="0.6s" src="assets1/images/demo/girl_looking-min.jpg" alt="" />
						</div>
			...
			<footer id="footer">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-3">
							<!-- Footer Logo -->
							<img class="footer-logo" src="assets1/images/logo-footer.png" alt="" />
		...
		<script type="text/javascript" src="assets1/js/scripts.js"></script>
		
		<!-- STYLESWITCHER - REMOVE -->
		<script async type="text/javascript" src="assets1/plugins/styleswitcher/styleswitcher.js"></script>

		<!-- REVOLUTION SLIDER -->
		<script type="text/javascript" src="assets1/plugins/slider.revolution/js/jquery.themepunch.tools.min.js"></script>
		<script type="text/javascript" src="assets1/plugins/slider.revolution/js/jquery.themepunch.revolution.min.js"></script>
		<script type="text/javascript" src="assets1/js/view/demo.revolution_slider.js"></script>
	</body>
</html>