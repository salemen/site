...
<select id="product-category_id" class="form-control" name="sost[id]">
    ...
    border-radius: 8px;			
                                            ...
                                            <h2 class="title text-center"> Расширенный поиск водного транспорта
						...
						<div class="col-sm-3 animated pulse faster">
							<center><?php if(!empty($avtovodniks->videl)){ ?> 
						...
						?>
									...
									<div class="productinfo text-center">
										 ...
										 <?php if ($mainImg['urlAlias']==='placeHolder') { ?>
                                                  ...
                                                  <a href="<?= yii\helpers\Url::to(['avtovodnik/'.$avtovodniks->id,'ads' =>'_'.$s.'_price_'.$avtovodniks->price]) ?>"
				...
				<p><h5><?= $avtovodniks -> tip ?></h5></p>
					 <h5><b>состояние: </b><?= $avtovodniks -> sostoyanie ?></h5>
										<h5><b>cтоимость:</b> <?= $avtovodniks -> price ?> руб.</h5>
                        ...
                        <li>КРАТКОЕ ОПИСАНИЕ:<hr> <?= mb_substr($avtovodniks->opisanie, 0, 150);  ?><br>
									  <a href="<?= yii\helpers\Url::to(['avtovodnik/'.$avtovodniks->id,'ads' =>'_'.$s.'_price_'.$avtovodniks->price]) ?>" class="btn btn-default1">подробнее</a>
						</li>
                             ...
                             <div id="brands_products2">
									...
									<span>КРАТКОЕ ОПИСАНИЕ:<hr><?= mb_substr($avtovodniks->opisanie, 0, 230);  ?><br>
									 <a href="tel:<?= $avtovodniks -> telephone ?>" target="_blank" class="btn btn-default1"> позвонить</a>
									 <a href="<?= yii\helpers\Url::to(['avtovodnik/'.$avtovodniks->id,'ads' =>'_'.$s.'_price_'.$avtovodniks->price]) ?>" class="btn btn-default1">подробнее</a>
									</span></small>
									 </div>
									</div>									  
