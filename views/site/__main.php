...
<head>
    ...
    $this->registerMetaTag(['name' => 'description', 'content' => 'SaleMen Купи продай и отдыхай. Универсальная, удобная и бесплатная платформа для покупок и продаж. ']);?>
    <?php $this->head() ?>
...
<?php $this->beginBody() ?>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
                                                ...
                                                <img src="web/images/home/logo.png" alt="" />
                                                </div>
    ...
    <li><a href="<?= \yii\helpers\Url::to (['/site/logout'])?>"><i class="fa fa-user"></i> <?=Yii::$app->user->identity['username']?> (Выход)</a></li>
								...
								<li><a href="<?= yii\helpers\Url::to (['/site/signup']) ?>"><i class="fa fa-crosshairs"></i> Регистрация </a></li>
                                                                ...
                                                                <li><a href="/catr/view" onclick="return getCart()" ><i class="fa fa-shopping-cart"></i> Корзина</a></li>
                                                                
                                                                
                                                                <li><a href= "<?= yii\helpers\Url::to (['/admin']) ?>" <i class="fa fa-lock"></i> В кабинет</a></li>
							</ul>
						</div>
					</div>
				</div>
...
<li><a href="<?=\yii\helpers\Url::to (['/admin/nedvigkvartiri/index'])?>">Недвижимость |</a></li>
                                                                <li><a href="<?=\yii\helpers\Url::home()?>">Автомобили |</a></li>
