...
<div class="avtovodnik-view">
    
    <table>
        <center>
    <a href="<?= yii\helpers\Url::to(['avtovodnik/index']) ?>" class="btn btn-success">Весь водный транспорт</a>
	  <a href="<?= yii\helpers\Url::to(['avtovodnik/create']) ?>" class="btn btn-success">➕</a>
        </center>
    </table>
   ...
   <p>
       <?php if (!empty($model->moder)){?>
		<?= Html::a('Как выглядит', ['/avtovodnik/view', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
		 <?php } ?>
