...
<div class="avtospec-view">
    
    <table>
        <center>
    <a href="<?= yii\helpers\Url::to(['avtospec/index']) ?>" class="btn btn-success">Вся спецтехника</a>
	<a href="<?= yii\helpers\Url::to(['avtospec/create']) ?>" class="btn btn-success">➕</a>
        </center>
    </table>
    ...
    <p>
		...
		<?= Html::a('Как выглядит', ['/avtospec/view', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
		 <?php } ?>
