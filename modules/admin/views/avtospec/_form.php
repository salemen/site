...
use app\modules\admin\models\Avtospectip;
    ...
    <?php $form = ActiveForm::begin(); ?>
	  ...
	  <?php 
		        $username = Yii::$app->user->identity['username'];
				 $idn = $_GET['id'];
				 if ($idn){
				 $username1= avtospec::find()->where(['id' => $idn])->andWhere(['username' => $username])->all();}?>
...
?>
 ...
 <center><div><table class="table table-hover table-striped"> 
 <tr>       
     <td><?= $form->field($model, 'tip')->dropDownList( avtospectip::find()->select(['type','id'])->indexBy('type')->column(),['promt'=>'Select tip']) ?></td>

     <td><?= $form->field($model, 'marka')->textInput(['maxlength' => true, 'placeholder' => 'обязательное поле']) ?></td>
 </tr>
<tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prhit;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$ao1dd;?></span></small>
</label></td></tr> 
 <?php } elseif(!$model->hit) { ?>
<tr><td><label>
<?= $form->field($model, 'hit')->checkbox(['label' => 'Добавить в <span style="color: blue;">ИЗБРАННУЮ</span> Спецтехнику']) ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prhit;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$ao1dd;?></span></small>
</label></td></tr>
 <?php }?>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prrekom;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$ao4dd;?></span></small>
</label></td></tr>
