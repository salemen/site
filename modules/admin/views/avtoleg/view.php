...
<div class="avtoleg-view">
    
    
     <table>
        <center>
    <a href="<?= yii\helpers\Url::to(['avtoleg/index']) ?>" class="btn btn-success">Все легковые автомобили</a>
	<a href="<?= yii\helpers\Url::to(['avtoleg/create']) ?>" class="btn btn-success">➕</a>
        </center>
    </table>
    ...
    <p>
		...
		<?= Html::a('Как выглядит', ['/avtoleg/view', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
		 <?php } ?>
