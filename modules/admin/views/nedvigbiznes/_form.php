...
<style>
 ...
 .nedvigbiznes-form div{
	 max-width: 800px;
 }
</style>

<div class="nedvigbiznes-form">
    ...
    <?php $form = ActiveForm::begin(); ?>
	  ...
	  <!--Ваш логин -->
       ...
       <center><div><table>
		...
		<tr>
    <!--//$form->field($model, 'typ_biznesa')->textInput(['maxlength' => true]) -->
   ...
   <tr id="thisguys" class="noshowtrue">
	<td align="left" colspan="2">
		...
		<script type="text/javascript">
			...
			$.ajax({
        type: 'POST',
        url: 'nedvigbiznes/update', // урл вставьте свой, этот для примера
        data: {
            declat:declat,
            declong:declong,
	...
	&nbsp;<center><a href="javascript:void(0)" onclick="hidethisguys()"><i class="btn btn-default" 
     ...
     <center><div> <table class="table table-hover table-striped table-responsive"> 
 <tr>
    ...
    $form->field($model, 'data')->textInput() -->
               ...
               <?php 
                ...
                $params = ['prompt' => 'Выберите регион/область'];
...
<td>
    <?= $form->field($model, 'type')->dropDownList( typebiznes::find()->select(['type','id'])->indexBy('type')->column(),['promt'=>'Select operaciya']) ?>
</td>

    <!--// $form->field($model, 'hit')->dropDownList([ 0 => '0', 1 => '1' ], ['prompt' => '0']) ?>

     //$form->field($model, 'new')->dropDownList([ 0 => '0', 1 => '1' ], ['prompt' => '0']) ?>

     //$form->field($model, 'sale')->dropDownList([ 0 => '0', 1 => '1'], ['prompt' => '0']) -->
<td>
    <?= $form->field($model, 'operaciya')->dropDownList( operaciya::find()->select('tip')->indexBy('tip')->column(),['promt'=>'Select operaciya']) ?> 
</td>
</tr>
<tr>
<td><?= $form->field($model, 'street')->textInput(['maxlength' => true, 'placeholder' => 'желательное поле']) ?></td>
	
    <td><?= $form->field($model, 'number_doma')->textInput(['type' => 'number']) ?></td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prverh;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$a6zz;?></span></small>
</label></td></tr> 
 <?php } elseif(!$model->verh) { ?>
<tr><td><label>
<?= $form->field($model, 'verh')->checkbox(['label' => 'Закрепить <span style="color: blue;">НА ВЕРХУ</span> в Бизнесе']) ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prverh;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$a6zz;?></span></small>
</label></td></tr>
 <?php }?>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prhit;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$al1dd;?></span></small>
</label></td></tr> 
 <?php } elseif(!$model->hit) { ?>
<tr><td><label>
<?= $form->field($model, 'hit')->checkbox(['label' => 'Добавить в <span style="color: blue;">ИЗБРАННЫЙ</span> бизнес']) ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prhit;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$al1dd;?></span></small>
</label></td></tr>
 <?php }?>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prrekom;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$al4dd;?></span></small>
</label></td></tr>
