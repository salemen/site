...
<style>
 ...
 .nedvig-zemli-form div{
	 max-width: 800px;
 }
</style>

<div class="nedvig-zemli-form" >
  ...
  <!--Ваш логин -->
		<?php 
		        $username = Yii::$app->user->identity['username'];
				 $idn = $_GET['id'];
				 if ($idn){
				 $username1= nedvigzemli::find()->where(['id' => $idn])->andWhere(['username' => $username])->all();}?>
  ...
  <style>
   ...
   <tr id="thisguys" class="noshowtrue">
	<td align="left" colspan="2">
		<center><p><strong>Укажите местоположение участка на карте</strong></p></center>
   ...
   <table class="table table-hover table-striped">  
    ...
    <tr> 
	<?= $form->field($model, 'adress')->textInput(['maxlength' => true, 'placeholder' => 'обязательное поле']) ?>
	</tr>
  <tr>
...
<tr>
    <td><?= $form->field($model, 'typ_uchastka')->dropDownList( tipuchastka::find()->select(['tip','id'])->indexBy('tip')->column(),['promt'=>'Select operaciya']) ?></td>
...
<tr>
    ...
    <td><?= $form->field($model, 'plochad_uchastka')->textInput(['type' => 'number','placeholder' => 'в сотках.']) ?></td>
	
	<td><?= $form->field($model, 'kad_nomer')->textInput(['rows' => 1, 'placeholder' => 'желательное поле']) ?></td>
</tr>
<tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prverh;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$a5zz;?></span></small>
</label></td></tr> 
 <?php } elseif(!$model->verh) { ?>
<tr><td><label>
<?= $form->field($model, 'verh')->checkbox(['label' => 'Закрепить <span style="color: blue;">НА ВЕРХУ</span> в Участках']) ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prverh;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$a5zz;?></span></small>
</label></td></tr>
 <?php }?>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prhit;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$ai1dd;?></span></small>
</label></td></tr> 
 <?php } elseif(!$model->hit) { ?>
<tr><td><label>
<?= $form->field($model, 'hit')->checkbox(['label' => 'Добавить в <span style="color: blue;">ИЗБРАННЫЕ</span> участки']) ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prhit;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$ai1dd;?></span></small>
</label></td></tr>
 <?php }?>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prrekom;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$ai4dd;?></span></small>
</label></td></tr>
