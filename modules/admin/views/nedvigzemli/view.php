...
$this->title ='Земельный участок № '. $model->id;
...
<div class="nedvig-zemli-view">

<table>
        <center>
    <a href="<?= yii\helpers\Url::to(['nedvigzemli/index']) ?>" class="btn btn-primary">Все земельные участки</a>
	  <a href="<?= yii\helpers\Url::to(['nedvigzemli/create']) ?>" class="btn btn-primary">➕</a>
        </center>
    </table>
    ...
    <p>
		...
		<?= Html::a('Как выглядит', ['/nedvigzemli/view', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
		 <?php } ?>
