...
<div class="nedvig-zemli-index">
        ...
        <center> 
         ...
         <a href="<?= yii\helpers\Url::to(['nedvigzemli/index']) ?>" class="btn btn-danger">Земельные участки</a>
...
.btn-1primary {
   ...
   <center><p>     	
	...
	<i class="fa fa-search"></i> Найти другие участки </i></a>
	</p></center>
						...
						<?php } ?>
								<div class="single-Products">
									...
									echo '<style="color: red">На модерации</style>';
											...
											<a href="<?= yii\helpers\Url::to(['/admin/nedvigzemli/view', 'id'=>$Nedvigzemlis->id]) ?>" 		 
                             ...
                             <!--<a href="<?= yii\helpers\Url::to(['/admin/nedvigzemli/view', 'id'=>$Nedvigzemlis->id]) ?>" class="btn btn-default">подробнее</a>-->
                             <a href="<?= yii\helpers\Url::to(['/admin/nedvigzemli/update', 'id'=>$Nedvigzemlis->id]) ?>" class="btn btn-default">изменить и продать быстрее</a></br>
...
<!--										<li><a href="#"><i class="fa fa-plus-square"></i>Add to compare</a></li>-->
         ...
         \yii\bootstrap\Modal::begin ([
			 ...
			 <form method="get" action="<?= yii\helpers\Url::to(['nedvigzemli/search' ]) ?>">
