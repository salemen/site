...
<div class="nedvig-doma-index">
        ...
        <center> 
         ...
         <a href="<?= yii\helpers\Url::to(['nedvigdoma/index']) ?>" class="btn btn-danger">Дома / Коттеджи</a> 
...
.btn-1primary {
   ...
   <center><p>     	
	...
	<i class="fa fa-search"></i> Найти другие дома </i></a>
	</p></center>
						...
						<?php } ?>
								<div class="single-Products">
									...
									echo '<style="color: red">На модерации</style>';
											 ...
											 <a href="<?= yii\helpers\Url::to(['/admin/nedvigdoma/view', 'id'=>$Nedvigdomas->id]) ?>"		 
                             ...
                             <!--<a href="<?= yii\helpers\Url::to(['/admin/nedvigdoma/view', 'id'=>$Nedvigdomas->id]) ?>" class="btn btn-default">подробнее</a>-->
                             <a href="<?= yii\helpers\Url::to(['/admin/nedvigdoma/update', 'id'=>$Nedvigdomas->id]) ?>" class="btn btn-default">изменить и продать быстрее</a></br>
