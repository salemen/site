...
$this->title = 'Коммерческая недвижимость, объявление № '. $model->id;
...
<div class="nedvig-kommercheska-view">

<table>
        <center>
    <a href="<?= yii\helpers\Url::to(['nedvigkommercheska/index']) ?>" class="btn btn-primary">Вся коммерческая недвижимость</a>
	  <a href="<?= yii\helpers\Url::to(['nedvigkommercheska/create']) ?>" class="btn btn-primary">➕</a>
        </center>
    </table>
    ...
    <p>
		...
		<?= Html::a('Как выглядит', ['/nedvigkommercheska/view', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
		 <?php } ?>
