...
?>
<div class="nedvig-kommercheska-search">
        ...
        <center> 
          ...
          <a href="<?= yii\helpers\Url::to(['nedvigkvartiri/index']) ?>" class="btn btn-primary">Квартиры</a>
         ...
         <a href="<?= yii\helpers\Url::to(['nedvigkommercheska/index']) ?>" class="btn btn-danger">Коммерческая недвижимость</a> 
...
.btn-1primary {
   ...
   <center><p>     	
	...
	<i class="fa fa-search"></i> Найти другую коммерческую </i></a>
	</p></center>
						...
						<?php } ?>
								<div class="single-Products">
									...
									echo '<style="color: red">На модерации</style>';
											...
											<a href="<?= yii\helpers\Url::to(['/admin/nedvigkommercheska/view', 'id'=>$Nedvigkommercheskas->id]) ?>"		 
                             ...
                             <!--<a href="<?= yii\helpers\Url::to(['/admin/nedvigkommercheska/view', 'id'=>$Nedvigkommercheskas->id]) ?>" class="btn btn-default">подробнее</a>-->
                             <a href="<?= yii\helpers\Url::to(['/admin/nedvigkommercheska/update', 'id'=>$Nedvigkommercheskas->id]) ?>" class="btn btn-default">изменить и продать быстрее</a></br>
...
<!--										<li><a href="#"><i class="fa fa-plus-square"></i>Add to compare</a></li>-->
        ...
        <!-------------Поиск Коммерческой------------->
         ...
         \yii\bootstrap\Modal::begin ([
			 ...
			 <form method="get" action="<?= yii\helpers\Url::to(['nedvigkommercheska/search' ]) ?>">
