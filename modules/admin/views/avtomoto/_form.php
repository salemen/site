...
use app\modules\admin\models\Avtomototip;
...
?>
 ...
 <center><div><table class="table table-hover table-striped"> 
<tr>
    <td><?= $form->field($model, 'tip')->dropDownList( avtomototip::find()->select(['tip','id'])->indexBy('tip')->column(),['promt'=>'Select tip']) ?></td>

    <td><?= $form->field($model, 'marka')->textInput(['placeholder' => 'обязательное поле']) ?></td>
</tr>
<tr>
    <td><?= $form->field($model, 'god')->dropDownList( avtogod::find()->select(['tip','id'])->indexBy('tip')->column(),['promt'=>'Select tip']) ?></td>

    <td><?= $form->field($model, 'probeg')->textInput(['maxlength' => true, 'placeholder' => 'обязательное поле']) ?></td>
</tr>
<tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prhit;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$ap1dd;?></span></small>
</label></td></tr> 
 <?php } elseif(!$model->hit) { ?>
<tr><td><label>
<?= $form->field($model, 'hit')->checkbox(['label' => 'Добавить в <span style="color: blue;">ИЗБРАННУЮ</span> Мототехнику']) ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prhit;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$ap1dd;?></span></small>
</label></td></tr>
 <?php }?>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prrekom;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$ap4dd;?></span></small>
</label></td></tr>
