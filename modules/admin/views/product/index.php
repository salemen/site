...
$this->title = 'Мои другие объявления';
$this->params['breadcrumbs'][] = $this->title;
?>

<?php
//                 $mainImg = $dataProvider->Img();
...
<div class="product-index">
    ...
    <center><p>
        <?= Html::a('<i class="fa fa-download"></i> ДОБАВИТЬ ОБЪЯВЛЕНИЕ <i class="fa fa-download"></i>', ['create'], ['class' => 'btn btn-warning']) ?>
						...
						<?php } ?>
								<div class="single-products">
									...
									echo '<style="color: red">На модерации</style>';
											 ...
											 <a href="<?= Url::to(['/admin/product/view', 'id'=>$products->id]) ?>"	 
											...
											<h5><?= $formatted_number = number_format($products->price, 0, ',', ' '); ?> руб.</h5>
                                                                                      ...
                                                                                      <!-- <p><a href="<?=Url::to(['category/view','id'=> $products ->category-> id])?>"></a></p>-->
																					   <p><?= $products -> category->name ?></p>
                                                                                       
				<!-- <a href="<?= Url::to(['/admin/product/view', 'id'=>$products->id]) ?>" class="btn btn-warning">подробнее</a></br>-->
				 <a href="<?= Url::to(['/admin/product/update', 'id'=>$products->id]) ?>" class="btn btn-warning">изменить и продать быстрее</a></br>
...
<select id="product-category_id" class="form-control" name="Product[category_id]">
     ...
     <?= \app\components\MenuWidget::widget (['tpl'=> 'select_product', 'model' => $model])?>
             ...
             <tr><td><input type="tel" style = "height: 30px; width: 200px;" placeholder="id объявления" name="p2"/></td></tr>
                ...
                <tr><td>	<center> <input type="submit" class="btn btn-warning" name="search" value="ПОИСК"></center></td></tr>
