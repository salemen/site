...
<center> <div><table class="table table-hover table-striped">  
 ...
 <tr><td><label for="box-11">
<?= $form->field($model, 'verh')->checkbox(['label' => 'Уже <span style="color: blue;">ЗАКРЕПЛЕНО</span> на верху', 'checked ' => true, ]) ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prverh;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$a1zz;?></span></small>
</label></td></tr> 
 <?php } elseif(!$model->verh){?>
<tr><td><label>
<?= $form->field($model, 'verh')->checkbox(['label' => 'Закрепить <span style="color: blue;">НА ВЕРХУ</span> на Главной ']) ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prverh;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$a1zz;?></span></small>
</label></td></tr>
 <?php }?>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prrekom;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$a4dd;?></span></small>
</label></td></tr>
