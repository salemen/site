...
<style>
 ...
 .nedvig-garagi-form div{
	 max-width: 800px;
 }
</style>

<div class="nedvig-garagi-form">
      ...
      <!--Ваш логин -->
	   <?php 
		        $username = Yii::$app->user->identity['username'];
				 $idn = $_GET['id'];
				 if ($idn){
				 $username1= nedviggaragi::find()->where(['id' => $idn])->andWhere(['username' => $username])->all();}?>
   ...
   <tr id="thisguys" class="noshowtrue">
	<td align="left" colspan="2">
		...
		<script type="text/javascript">
			...
			$.ajax({
        type: 'POST',
        url: 'nedviggaragi/update', // урл вставьте свой, этот для примера
        data: {
            declat:declat,
            declong:declong,
...
<tr>
 ...
 <tr>
    <td><?= $form->field($model, 'type_materiala')->dropDownList( garagimaterial::find()->select(['tip','id'])->indexBy('tip')->column(),['promt'=>'Select tip']) ?></td>
...
<tr>
   <td> <?= $form->field($model, 'ochrana')->dropDownList( garagioxrana::find()->select(['tip','id'])->indexBy('tip')->column(),['promt'=>'Select tip']) ?></td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prhit;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$ak1dd;?></span></small>
</label></td></tr> 
 <?php } elseif(!$model->hit) { ?>
<tr><td><label>
<?= $form->field($model, 'hit')->checkbox(['label' => 'Добавить в <span style="color: blue;">ИЗБРАННЫЕ</span> гаражи']) ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prhit;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$ak1dd;?></span></small>
</label></td></tr>
 <?php }?>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?=$prrekom;?> руб. )<small class="ttip">ЧТО ЭТО ?<span><?=$ak4dd;?></span></small>
</label></td></tr>
