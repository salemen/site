...
<div class="nedvig-garagi-view">

<table>
        <center>
    <a href="<?= yii\helpers\Url::to(['nedviggaragi/index']) ?>" class="btn btn-primary">Все гаражи</a>
	  <a href="<?= yii\helpers\Url::to(['nedviggaragi/create']) ?>" class="btn btn-primary">➕</a>
        </center>
    </table>
    ...
    <p>
	   <?php if (!empty($model->moder)){?>
		<?= Html::a('Как выглядит', ['/nedviggaragi/view', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
		 <?php } ?>
