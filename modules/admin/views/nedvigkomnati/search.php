...
<div class="nedvig-komnati-index">
        ...
        <center> 
         ...
         <a href="<?= yii\helpers\Url::to(['nedvigkomnati/index']) ?>" class="btn btn-danger">Комнаты</a>
...
.btn-1primary {
   ...
   <center><p>     	
	...
	<i class="fa fa-search"></i> Найти другие комнаты </i></a>
	</p></center>
						...
						<?php } ?>
								<div class="single-Products">
									...
									echo '<style="color: red">На модерации</style>';
										 ...
										 <a href="<?= yii\helpers\Url::to(['/admin/nedvigkomnati/view', 'id'=>$Nedvigkomnatis->id]) ?>"			 
                             ...
                             <!--<a href="<?= yii\helpers\Url::to(['/admin/nedvigkomnati/view', 'id'=>$Nedvigkomnatis->id]) ?>" class="btn btn-default">подробнее</a>-->
                             <a href="<?= yii\helpers\Url::to(['/admin/nedvigkomnati/update', 'id'=>$Nedvigkomnatis->id]) ?>" class="btn btn-default">изменить и продать быстрее</a><br>
...
<!--										<li><a href="#"><i class="fa fa-plus-square"></i>Add to compare</a></li>-->
         ...
         \yii\bootstrap\Modal::begin ([
			 ...
			 <form method="get" action="<?= yii\helpers\Url::to(['nedvigkomnati/search']) ?>">
