...
<div class="avtogruz-view">
    
     <table>
        <center>
    <a href="<?= yii\helpers\Url::to(['avtogruz/index']) ?>" class="btn btn-success">Все грузовые автомобили</a>
	<a href="<?= yii\helpers\Url::to(['avtogruz/create']) ?>" class="btn btn-success">➕</a>
        </center>
    </table>
    ...
    <p>
		...
		<?= Html::a('Как выглядит', ['/avtogruz/view', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
		 <?php } ?>
