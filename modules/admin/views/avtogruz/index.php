...
$this->title = 'Мои Грузовые автомобили';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="avtogruz-index">
        ...
        <center> 
         ...
         <a href="<?= Url::to(['avtogruz/index']) ?>" class="btn btn-danger">Грузовые/Автобусы</a>
...
<table>
    <center> <h4>Грузовые автомобили: мои объявления</h4> </center>
									...
									echo '<style="color: red">На модерации</style>';
											 ...
											 <a href="<?= Url::to(['/admin/avtogruz/view', 'id'=>$Avtogruzs->id]) ?>"								 
												 <li><?=Html::img($mainImg->getUrl('x200'), ['alt' => '']) ?></li></a>
												                             ...
												                             <?php } ?>  
                                      <h5> ID <?= $Avtogruzs->id ?> </h5>
									   <h5><?= $Avtogruzs -> tip ?>. 
										год: <?= $Avtogruzs -> god ?></h5>																			 
											<h5><?= $Avtogruzs->price ?> руб.</h5>
                                                     
                                                                                       
                             <!--<a href="<?= Url::to(['/admin/avtogruz/view', 'id'=>$Avtogruzs->id]) ?>" class="btn btn-default">подробнее</a>-->
                             <a href="<?= Url::to(['/admin/avtogruz/update', 'id'=>$Avtogruzs->id]) ?>" class="btn btn-default">изменить и продать быстрее</a></br>
                         
                             <?php echo Html::a('Удалить', ['/admin/avtogruz/delete', 'id'=>$Avtogruzs->id], [
                                                           'data' => [
                                                           'method' => 'post',
