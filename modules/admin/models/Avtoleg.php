...
/**
 * This is the model class for table "avtoleg".
 *
 * @property int $id
 ...
 */
class Avtoleg extends \yii\db\ActiveRecord
{
    public $image;
    public $gallery;
    ...
    {
        return [
            [['parent_id', 'probeg', 'price','telephone','moder','hit', 'hitok', 'new', 'newok', 'sale', 'saleok', 'rekom', 'rekomok', 'videl', 'videlok'], 'integer'],
            [['data', 'hitdate', 'newdate', 'saledate', 'rekomdate', 'videldate'], 'safe'],
            [['tip', 'marka', 'god', 'probeg', 'korobka', 'dvigatel', 'privod', 'sostoyanie', 'opisanie', 'price', 'oblast'], 'required'],
            [['opisanie'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
			...
			'hit' => 'В Избранном в разделе Автотехника',
			'hitok' => 'hitok',
			'hitdate'=> 'hitdate',
