...
/**
 * This is the model class for table "avtospec".
 *
 * @property int $id
 ...
 */
class Avtospec extends \yii\db\ActiveRecord
{
     public $image;
    public $gallery;
    ...
    {
        return [
            [['tip', 'marka', 'god', 'probeg', 'dvigatel', 'privod', 'sostoyanie', 'opisanie', 'price', 'oblast'], 'required'],
            ...
            [['opisanie'], 'string'],
            [['username', 'tip', 'marka', 'god', 'probeg', 'dvigatel', 'privod', 'sostoyanie'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
			...
			'hit' => 'В Избранном в разделе Спецтехника',
			'hitok' => 'hitok',
			'hitdate'=> 'hitdate',
